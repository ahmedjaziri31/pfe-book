...
\begin{figure}[htbp]
    \centering
    % Top row - three mobile interface images side by side
    \begin{minipage}{0.32\textwidth}
        \centering
        % \includegraphics[width=\linewidth]{images/mobile_invest_interface.png}
        \caption*{Investment Interface}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        % \includegraphics[width=\linewidth]{images/mobile_payment_process.png}
        \caption*{Payment Process}
    \end{minipage}
    \hfill
    \begin{minipage}{0.32\textwidth}
        \centering
        % \includegraphics[width=\linewidth]{images/mobile_withdraw_interface.png}
...
\begin{figure}[htbp]
    \centering
    % \includegraphics[width=0.9\textwidth]{images/admin_blockchain_dashboard.png}
