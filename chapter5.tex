...
\subsection{Test}
\subsubsection{Payment Integration Testing}
The blockchain payment system underwent comprehensive testing to ensure secure and reliable investor transactions. All payment flows were validated through Paymee integration, confirming successful on-chain recording of investments.

\subsubsection{Smart Contract Validation}
Smart contract functions were thoroughly tested on the Sepolia testnet, validating investment recording, project registration, and rent distribution mechanisms. All test scenarios passed successfully, confirming the reliability of the blockchain implementation.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{3cm}|p{10cm}|}
        ...
        \begin{itemize}
            ...
            \item Enhance payment reconciliation between Paymee and blockchain
            \item Plan for mainnet deployment and security audits
        \end{itemize} \\
        \hline
    \end{tabular}
