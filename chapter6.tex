...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=0.8\textwidth]{images/notification_system_use_case.png}
%     \caption{Notification System Use Case Diagram}
%     \label{fig:notification-system-use-case}
% \end{figure}
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=0.9\textwidth]{images/notification_system_class_diagram.png}
%     \caption{Notification System Class Diagram}
%     \label{fig:notification-system-class}
% \end{figure}
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=1\textwidth]{images/notification_system_sequence.png}
%     \caption{Notification System Sequence Diagram}
%     \label{fig:notification-system-sequence}
% \end{figure}
