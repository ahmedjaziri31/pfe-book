...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.35\textwidth]{images/geo-propriety-data.png} % Replace with your actual image path
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{images/top_15_feature_importance.png} % Assuming image is in 'images' directory
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.45\textwidth]{images/mobile_future_evaluation.png} % Replace with your actual image path
